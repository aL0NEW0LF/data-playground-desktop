...
class MLPage(ctk.CTkFrame):
    ...
    def optionmenu_callback(self, choice: str):
        ...
        if choice == 'Linear Regression':
            ...
            NNeighborsLabel = ctk.CTkLabel(self.ModelConfigFrame, text="N neighbors:", text_color="#FFFFFF",
                                           font=SMALLFONT)
            ...
            AlgorithmLabel = ctk.CTkLabel(self.ModelConfigFrame, text="Algorithm:", text_color="#FFFFFF",
                                          font=SMALLFONT)
